...
INSERT INTO `persona` (`id`, `areaestudio`, `correo`, `especialidad`, `motivoderegistro`, `nivelacademico`, `nombres`, `password`, `tipodeusuario`) VALUES
...
INSERT INTO `curso` (`id`, `maxcantalumnos`, `maxhorduracion`, `nombre`, `totaldocu`, `profesor_id`) VALUES
	(1, 1, 40, 'matematicas', 1, 11),
	(2, 3, 50, 'lenguaje', 1, 11),
	(5, 5, 30, 'sistemas', 1, 3),
	(7, 1, 40, 'basededatos', 1, 11);

INSERT INTO `curso_alumnos` (`curso_id`, `persona_id`) VALUES
	(2, 60),
	(7, 60),
	(1, 61),
	(2, 61);
